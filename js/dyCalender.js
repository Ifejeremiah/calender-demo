...
(function (global) {
    ...
    function drawCalendarMonthTable(data, option) {
        ...
        var
            table,
            div, container, elem, prevnextcontainer;
    ...
    function onClick() {
        ...
        document.body.onclick = function (e) {
            ...
            if ((targetDomObject) && (targetDomObject.classList) && (targetDomObject.classList.contains("dycalendar-prev-next-btn"))) {
                ...
                option = JSON.parse(targetDomObject.parentElement.parentElement.getAttribute("data-option"));
            ...
            if ((targetDomObject) && (targetDomObject.classList) && targetDomObject.classList.contains('dycalendar-date')) {
                ...
                const composeDate = date[0] + " " + targetDomObject.innerText + ", " + date[1];
                ...
                console.log('value of date ==>', dateMap[dateResult.getDay()] + ", " + targetDomObject.innerText)
            }
        };
    }
